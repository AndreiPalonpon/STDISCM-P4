...
import { CheckCircle, Trash2, AlertTriangle, ShoppingCart as CartIcon } from 'lucide-react'; // Changed this line
    ...
    <div className="space-y-6">
      ...
      {cartCourses.length === 0 ? (
        <div className="card text-center py-12">
          <CartIcon className="h-12 w-12 text-gray-300 mx-auto mb-4" /> {/* Fixed this line */}

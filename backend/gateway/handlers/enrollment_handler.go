...
import (
	...
	pb_auth "stdiscm_p4/backend/pb/auth"             // To retrieve student_id from context
	pb_enrollment "stdiscm_p4/backend/pb/enrollment" // The Enrollment Service gRPC contract
)

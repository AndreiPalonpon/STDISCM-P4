...
import (
	...
	"stdiscm_p4/backend/gateway/util" // Assuming a utility package for JSON response handling
	pb "stdiscm_p4/backend/pb/auth"   // Assuming the gRPC generated package
)

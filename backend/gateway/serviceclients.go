...
import (
	...
	pb_admin "stdiscm_p4/backend/pb/admin"
	pb_auth "stdiscm_p4/backend/pb/auth"
	pb_course "stdiscm_p4/backend/pb/course"
	pb_enrollment "stdiscm_p4/backend/pb/enrollment"
	pb_grade "stdiscm_p4/backend/pb/grade"
)

...
func main() {
	...
	port := getEnv("GRADE_SERVICE_PORT", "50053")
	mongoURI := getEnv("GRADE_MONGO_URI", "mongodb://localhost:27017")
	...
	// Initialize and register Grade Service
	...
	go func() {
		log.Printf("Grade Service is listening on port %s", port)
